...
import { TimelineChart, Card as TremorCard, Text } from '@tremor/react';
...
function Projects() {
  ...
  const fetchData = async () => {
    try {
      ...
      const timelineData = projectsRes.data.map((project) => ({
        title: project.status,
        date: new Date(project.createdAt).toLocaleDateString(),
        description: customers.find((c) => c._id === project.customerId)?.name || 'Unknown',
      }));
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Timeline Chart */}
      <TremorCard>
        <Text>Project Progress Timeline</Text>
        <TimelineChart
          data={chartData}
          titleKey="title"
          dateKey="date"
